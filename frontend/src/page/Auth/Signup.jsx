...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response =await api.post( '/api/signup',inputs);
      
      console.log("Signup successfull"+ response.data.user);
      setInputs({});
      navigate('/todo');
  ...
  return (
    <div className="w-[350px] sm:w-[520px] flex mx-auto items-center min-h-screen px-2">
      <div className="border-gray-400 border rounded-[8px] w-full px-6 py-5">
        <h2 className="pb-4 text-4xl font-bold text-center">SignUp</h2>
